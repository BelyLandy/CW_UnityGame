...
namespace FreeDraw
{
    ...
    {
        // PEN COLOUR
        public Color Pen_Colour = Color.clear;     // Change these to change the default drawing settings
...
// 3. Assign this method to the current_brush variable (see how PenBrush does this)
        ...
        public void CircleBrush(Vector2 world_position)
        {
            ...
            // If this is the first click, just draw the circle at the point
            if (previous_drag_position == Vector2.zero)
            {
            ...
            {
                // Draw circles between the previous and current positions for smooth effect
